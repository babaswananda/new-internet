 ...
 * SplinePureHtml
 * 
 * A COMPLETELY NEW TEST PAGE that uses a pure HTML approach with no dependencies.
 * This is a standalone page that doesn't use any Spline-specific components or libraries.
 */
export default function SplinePureHtml() {
  const containerRef = useRef<HTMLDivElement>(null);
  
  // Set up the Spline scene after the component mounts
  useEffect(() => {
    ...
    try {
      ...
      // Set attributes
      iframe.src = 'https://prod.spline.design/EegKcAAn0DX9KgHh/embed';
