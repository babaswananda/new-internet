 ...
 * SplineSceneTest
 * 
 * A COMPLETELY NEW TEST PAGE that uses a direct iframe embed with the scene.splinecode URL.
 * This is a standalone page that doesn't use any of the existing components.
 */
export default function SplineSceneTest() {
  // Direct scene URL (not embed URL)
  const sceneUrl = "https://prod.spline.design/EegKcAAn0DX9KgHh/scene.splinecode";

  return (
    <div className="min-h-screen bg-black text-white">
      {/* DIRECT IFRAME EMBED WITH SCENE URL - ALWAYS VISIBLE */}
