 ...
 * NewPageWithSpline
 * 
 * A BRAND NEW PAGE with the Spline 3D background directly embedded.
 * This page is completely independent and doesn't use any existing components.
 */
export default function NewPageWithSpline() {
  return (
    <div className="min-h-screen bg-black text-white">
      {/* DIRECT SPLINE BACKGROUND - ALWAYS VISIBLE */}
