      ...
      <div className="container mx-auto px-4 relative z-10">
        ...
        >
          ...
          <motion.div variants={itemVariants} className="mb-16">
            <GlowingCard className="bg-black/30 backdrop-blur-sm p-12 rounded-lg border border-white/10">
              ...
              {ioDefinitions.map((def, index) => (
                ...
                >
                  <div className="text-center">
                    ...
                    <h4 className={`text-sm font-semibold mb-1 bg-clip-text text-transparent bg-gradient-to-r ${def.color}`}>
                      {def.acronym}
                    </h4>
          ...
          <motion.div variants={itemVariants} className="mb-16">
            <GlowingCard className="bg-black/30 backdrop-blur-sm p-8 rounded-lg border border-green-500/20">
              <h3 className="text-2xl font-semibold mb-6 text-green-400 text-center">🔗 IO Command Examples</h3>
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div className="bg-black/60 rounded-lg p-4 font-mono text-sm">
                  <div className="text-green-400 mb-2">$ io deploy --agent="customer-support" --handle="mycompany"</div>
                ...
                <div className="bg-black/60 rounded-lg p-4 font-mono text-sm">
                  <div className="text-green-400 mb-2">$ io orchestrate --workflow="content-pipeline" --input="blog-ideas"</div>
                ...
                <div className="bg-black/60 rounded-lg p-4 font-mono text-sm">
                  <div className="text-green-400 mb-2">$ io route --intent="schedule-meeting" --agents="calendar,email,assistant"</div>
                ...
                <div className="bg-black/60 rounded-lg p-4 font-mono text-sm">
                  <div className="text-green-400 mb-2">$ io scale --infrastructure="auto" --demand="high"</div>
              ...
              <div className="text-center mt-6">
                <p className="text-gray-400">
                  Ready to command your agents? <span className="text-green-400">.commandline/claim</span> is where it all begins.<br />
