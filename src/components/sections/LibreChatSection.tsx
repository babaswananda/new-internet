...
const LibreChatSection: React.FC = () => {
  ...
  return (
    <div className="relative min-h-screen w-full py-24 overflow-hidden" id="librechat">
      ...
      <div className="container mx-auto px-4 relative z-10">
        ...
        >
          ...
          >
            Powerful AI chat capabilities with tiered access to multiple AI systems and advanced features.
          </motion.p>
...
export default LibreChatSection;
