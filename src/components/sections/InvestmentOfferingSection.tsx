...
const InvestmentOfferingSection: React.FC = () => {
  ...
  const contributorTiers = [
    {
      tier: 'Signal',
      unlocks: 'Protocol badge, community access, Agent Key minting'
    },
    {
      tier: 'Operator',
      unlocks: 'Agent Key, 6-month access, dev channel, on-chain credentials'
    },
    {
      tier: 'Architect',
      unlocks: 'Endpoint mint rights, private dev forum, AI Token usage'
    },
    {
      tier: 'Sovereign',
    ...
    <section className="relative min-h-screen w-full py-24 overflow-hidden">
      ...
      <div className="container mx-auto px-4 relative z-10">
        ...
        >
          ...
          >
            <p>This isn&apos;t a product drop. It&apos;s a protocol offering.</p>
            <ul className="mt-6 space-y-2 list-none">
              <li>• Seed round into protocol access</li>
              <li>• AI Token-based tiers</li>
              <li>• Agent Key reservation</li>
              <li>• Contributor credentials</li>
              <li>• Earnings participation</li>
            </ul>
          </motion.div>
          ...
          <motion.div
            ...
            className="mb-12"
          >
            <GlowingCard className="bg-black/30 backdrop-blur-sm p-8 rounded-sm border border-blue-500/20">
              ...
              <ul className="space-y-4 text-gray-300">
                <li className="flex items-start">
                  ...
                  <span>Closes May 23</span>
                </li>
                <li className="flex items-start">
                  <span className="mr-2">⟶</span>
                  <span>Agent Keys mint soon</span>
                </li>
                <li className="flex items-start">
                  <span className="mr-2">⟶</span>
                  <span>On-chain credentials for all tiers</span>
                </li>
                <li className="flex items-start">
                  <span className="mr-2">⟶</span>
                ...
                <li className="flex items-start">
                  <span className="mr-2">⟶</span>
                  <span>This isn't early access. It's early territory.</span>
                </li>
              </ul>
            </GlowingCard>
          </motion.div>
