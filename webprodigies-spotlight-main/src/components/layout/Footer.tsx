  ...
  const footerSections = [
    {
      ...
      links: [
        ...
        { href: '/webinars', label: 'Browse Webinars' },
        { href: '/create', label: 'Create Webinar' },
    ...
    },
    {
      title: 'Features',
      links: [
        { href: '/features/streaming', label: 'Live Streaming' },
        { href: '/features/tokens', label: 'Token Gating' },
        { href: '/features/ai', label: 'AI Co-hosts' },
        { href: '/features/monetization', label: 'Monetization' },
      ]
    },
    {
      title: 'Resources',
        ...
        <div className="border-t border-white/10 mt-12 pt-8">
          <div className="flex flex-col md:flex-row justify-between items-center">
            <div className="text-gray-400 text-sm mb-4 md:mb-0">
              © 2024 Unified AI Webinar Platform. All rights reserved.
            </div>
            
            {/* Powered by Unified AI Link */}
            <div className="flex items-center space-x-4">
              <Link 
                href="http://localhost:3002" 
                className="flex items-center space-x-2 text-gray-400 hover:text-purple-400 transition-colors text-sm group"
              >
